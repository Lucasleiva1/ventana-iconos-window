  ...
  return (
    <>
      <CollapsibleSection
        ...
        description="Inicio con Windows, comportamiento del Administrador y rendimiento."
      >
        <div className="settings-section-toolbar">
          <span>Preferencias de toda la aplicación</span>
          <button
            className="button button-ghost"
            onClick={() => void runAction(async () => drawerApi.openDataRoot())}
          >
        ...
        <div className="settings-grid">
          ...
          <p className="settings-note">La transparencia se ajusta en cada ventana con su barra de Opacidad: al fondo se vuelve sólido, al principio se vuelve invisible. El Administrador siempre es sólido.</p>
          </article>
        </div>
      </CollapsibleSection>
      ...
      <CollapsibleSection
        ...
        description="Versión instalada y búsqueda de nuevas versiones firmadas."
        meta={`v${appVersion}`}
      >
      ...
      <CollapsibleSection
        title="Backups"
        description="Crear, importar, exportar y restaurar copias de tu configuración."
        meta={`${backupCenter?.backups.length ?? 0} copias`}
      >
        <div className="settings-grid settings-grid-single">
      ...
      <CollapsibleSection
        ...
        description="Comprobar el estado local o restablecer solamente la apariencia."
      >
        <div className="settings-grid">
          <article className="settings-card">
